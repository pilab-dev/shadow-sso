...
import (
	...
	"github.com/rs/zerolog/log"              // Global zerolog, keep for now if still used elsewhere or for comparison
...
type OAuthService struct {
	...
	userRepo     services.UserServiceInternal // Changed from UserStore to UserServiceInternal
...
func NewOAuthService(
	oauthRepo OAuthRepository,
	userRepo services.UserServiceInternal, // Changed
