...
// Source: internal/federation/provider.go
//
// Generated by this command:
//
//	mockgen -source=internal/federation/provider.go -destination=mocks/mock_federation_provider.go -package=mocks OAuth2Provider
//
