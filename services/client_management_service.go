...
// --- Interface for the new ClientService ---
type ClientServiceInternal interface {
	RegisterClient(ctx context.Context, req *dto.ClientCreateRequest) (*dto.ClientResponse, string, error) // Returns plaintext secret separately
...
type ClientServiceImpl struct {
	oauthRepo    ssso.OAuthRepository // Contains client methods
	secretHasher PasswordHasher
}

// NewClientServiceImpl creates a new ClientServiceImpl.
func NewClientServiceImpl(oauthRepo ssso.OAuthRepository, hasher PasswordHasher) *ClientServiceImpl {
