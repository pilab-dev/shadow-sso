...
import (
	...
	"fmt"
	"strings"
	"time" // Added for domain to DTO conversion if needed
...
// --- Interface for the new IdPService ---
type IdPServiceInternal interface {
	...
	GetIdPByName(ctx context.Context, name string) (*dto.IdentityProviderResponse, error) // Assuming this might be needed
...
// NewIdPServiceImpl creates a new IdPServiceImpl.
func NewIdPServiceImpl(idpRepo domain.IdPRepository) *IdPServiceImpl {
	return &IdPServiceImpl{
		idpRepo: idpRepo,
	}
}

func (s *IdPServiceImpl) AddIdP(ctx context.Context, req *dto.IdentityProviderCreateRequest) (*dto.IdentityProviderResponse, error) {
...
func (s *IdPServiceImpl) GetIdPByID(ctx context.Context, idpID string) (*dto.IdentityProviderResponse, error) {
...
func (s *IdPServiceImpl) GetIdPByName(ctx context.Context, name string) (*dto.IdentityProviderResponse, error) {
...
func (s *IdPServiceImpl) ListIdPs(ctx context.Context, onlyEnabled bool) ([]*dto.IdentityProviderResponse, error) {
...
func (s *IdPServiceImpl) UpdateIdP(ctx context.Context, idpID string, req *dto.IdentityProviderUpdateRequest) (*dto.IdentityProviderResponse, error) {
...
func (s *IdPServiceImpl) DeleteIdP(ctx context.Context, idpID string) error {
...
type IdPManagementServer struct {
	...
	service IdPServiceInternal // Use the new internal service
}

// NewIdPManagementServer creates a new IdPManagementServer.
// It now expects an IdPServiceInternal implementation.
func NewIdPManagementServer(service IdPServiceInternal) *IdPManagementServer {
...
func (s *IdPManagementServer) AddIdP(ctx context.Context, req *connect.Request[ssov1.AddIdPRequest]) (*connect.Response[ssov1.AddIdPResponse], error) {
	...
	if err != nil {
		...
		if strings.Contains(err.Error(), "already exists") {
			return nil, connect.NewError(connect.CodeAlreadyExists, err.Error())
		}
