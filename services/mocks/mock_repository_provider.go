...
// Source: services/repository_provider.go
//
// Generated by this command:
//
//	mockgen -source=services/repository_provider.go -destination=services/mocks/mock_repository_provider.go -package=mock_services
//
