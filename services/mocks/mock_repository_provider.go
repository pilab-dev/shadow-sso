...
//
//	mockgen -source=repository_provider.go -destination=mocks/mock_repository_provider.go -package=mock_services
//
...
// AuditLogRepository mocks base method.
func (m *MockRepositoryProvider) AuditLogRepository(ctx context.Context) domain.AuditLogRepository {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AuditLogRepository", ctx)
	ret0, _ := ret[0].(domain.AuditLogRepository)
	return ret0
}

// AuditLogRepository indicates an expected call of AuditLogRepository.
func (mr *MockRepositoryProviderMockRecorder) AuditLogRepository(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AuditLogRepository", reflect.TypeOf((*MockRepositoryProvider)(nil).AuditLogRepository), ctx)
}
...
// RealmSettingsRepository mocks base method.
func (m *MockRepositoryProvider) RealmSettingsRepository(ctx context.Context) domain.RealmSettingsRepository {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RealmSettingsRepository", ctx)
	ret0, _ := ret[0].(domain.RealmSettingsRepository)
	return ret0
}

// RealmSettingsRepository indicates an expected call of RealmSettingsRepository.
func (mr *MockRepositoryProviderMockRecorder) RealmSettingsRepository(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RealmSettingsRepository", reflect.TypeOf((*MockRepositoryProvider)(nil).RealmSettingsRepository), ctx)
}
