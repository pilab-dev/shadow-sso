...
const (
	...
	TokenStoreServiceName = "sso.v1.TokenStoreService"
)
...
const (
	...
	TokenStoreServiceDeleteRefreshTokenProcedure = "/sso.v1.TokenStoreService/DeleteRefreshToken"
	...
	TokenStoreServiceStoreAccessTokenMetadataProcedure = "/sso.v1.TokenStoreService/StoreAccessTokenMetadata"
	...
	TokenStoreServiceGetAccessTokenMetadataProcedure = "/sso.v1.TokenStoreService/GetAccessTokenMetadata"
	...
	TokenStoreServiceGetDeviceAuthByDeviceCodeProcedure = "/sso.v1.TokenStoreService/GetDeviceAuthByDeviceCode"
	...
	TokenStoreServiceGetDeviceAuthByUserCodeProcedure = "/sso.v1.TokenStoreService/GetDeviceAuthByUserCode"
	// TokenStoreServiceUpdateDeviceAuthProcedure is the fully-qualified name of the TokenStoreService's
	// UpdateDeviceAuth RPC.
	TokenStoreServiceUpdateDeviceAuthProcedure = "/sso.v1.TokenStoreService/UpdateDeviceAuth"
	// TokenStoreServiceDeleteDeviceAuthProcedure is the fully-qualified name of the TokenStoreService's
	// DeleteDeviceAuth RPC.
	TokenStoreServiceDeleteDeviceAuthProcedure = "/sso.v1.TokenStoreService/DeleteDeviceAuth"
	// TokenStoreServiceStorePKCEStateProcedure is the fully-qualified name of the TokenStoreService's
	// StorePKCEState RPC.
	TokenStoreServiceStorePKCEStateProcedure = "/sso.v1.TokenStoreService/StorePKCEState"
	// TokenStoreServiceGetPKCEStateProcedure is the fully-qualified name of the TokenStoreService's
	// GetPKCEState RPC.
	TokenStoreServiceGetPKCEStateProcedure = "/sso.v1.TokenStoreService/GetPKCEState"
	// TokenStoreServiceDeletePKCEStateProcedure is the fully-qualified name of the TokenStoreService's
	// DeletePKCEState RPC.
	TokenStoreServiceDeletePKCEStateProcedure = "/sso.v1.TokenStoreService/DeletePKCEState"
)

// TokenStoreServiceClient is a client for the sso.v1.TokenStoreService service.
...
// NewTokenStoreServiceClient constructs a client for the sso.v1.TokenStoreService service. By
...
// Set calls sso.v1.TokenStoreService.Set.
...
// Get calls sso.v1.TokenStoreService.Get.
...
// Delete calls sso.v1.TokenStoreService.Delete.
...
// StoreAuthCode calls sso.v1.TokenStoreService.StoreAuthCode.
...
// GetAuthCode calls sso.v1.TokenStoreService.GetAuthCode.
...
// DeleteAuthCode calls sso.v1.TokenStoreService.DeleteAuthCode.
...
// StoreRefreshToken calls sso.v1.TokenStoreService.StoreRefreshToken.
...
// GetRefreshToken calls sso.v1.TokenStoreService.GetRefreshToken.
...
// DeleteRefreshToken calls sso.v1.TokenStoreService.DeleteRefreshToken.
...
// StoreAccessTokenMetadata calls sso.v1.TokenStoreService.StoreAccessTokenMetadata.
...
// GetAccessTokenMetadata calls sso.v1.TokenStoreService.GetAccessTokenMetadata.
...
// DeleteAccessTokenMetadata calls sso.v1.TokenStoreService.DeleteAccessTokenMetadata.
...
// StoreOIDCFlw calls sso.v1.TokenStoreService.StoreOIDCFlw.
...
// GetOIDCFlw calls sso.v1.TokenStoreService.GetOIDCFlw.
...
// DeleteOIDCFlw calls sso.v1.TokenStoreService.DeleteOIDCFlw.
...
// UpdateOIDCFlw calls sso.v1.TokenStoreService.UpdateOIDCFlw.
...
// StoreUserSession calls sso.v1.TokenStoreService.StoreUserSession.
...
// GetUserSession calls sso.v1.TokenStoreService.GetUserSession.
...
// DeleteUserSession calls sso.v1.TokenStoreService.DeleteUserSession.
...
// StoreDeviceAuth calls sso.v1.TokenStoreService.StoreDeviceAuth.
...
// GetDeviceAuthByDeviceCode calls sso.v1.TokenStoreService.GetDeviceAuthByDeviceCode.
...
// GetDeviceAuthByUserCode calls sso.v1.TokenStoreService.GetDeviceAuthByUserCode.
...
// UpdateDeviceAuth calls sso.v1.TokenStoreService.UpdateDeviceAuth.
...
// DeleteDeviceAuth calls sso.v1.TokenStoreService.DeleteDeviceAuth.
...
// StorePKCEState calls sso.v1.TokenStoreService.StorePKCEState.
...
// GetPKCEState calls sso.v1.TokenStoreService.GetPKCEState.
...
// DeletePKCEState calls sso.v1.TokenStoreService.DeletePKCEState.
...
// TokenStoreServiceHandler is an implementation of the sso.v1.TokenStoreService service.
...
func NewTokenStoreServiceHandler(svc TokenStoreServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/sso.v1.TokenStoreService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTokenStoreServiceHandler) Set(context.Context, *connect.Request[v1.SetRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.Set is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) Get(context.Context, *connect.Request[v1.GetRequest]) (*connect.Response[v1.GetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.Get is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) Delete(context.Context, *connect.Request[v1.DeleteRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.Delete is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) StoreAuthCode(context.Context, *connect.Request[v1.StoreAuthCodeRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.StoreAuthCode is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) GetAuthCode(context.Context, *connect.Request[v1.GetAuthCodeRequest]) (*connect.Response[v1.AuthCode], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.GetAuthCode is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) DeleteAuthCode(context.Context, *connect.Request[v1.DeleteAuthCodeRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.DeleteAuthCode is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) StoreRefreshToken(context.Context, *connect.Request[v1.StoreRefreshTokenRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.StoreRefreshToken is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) GetRefreshToken(context.Context, *connect.Request[v1.GetRefreshTokenRequest]) (*connect.Response[v1.RefreshToken], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.GetRefreshToken is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) DeleteRefreshToken(context.Context, *connect.Request[v1.DeleteRefreshTokenRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.DeleteRefreshToken is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) StoreAccessTokenMetadata(context.Context, *connect.Request[v1.StoreAccessTokenMetadataRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.StoreAccessTokenMetadata is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) GetAccessTokenMetadata(context.Context, *connect.Request[v1.GetAccessTokenMetadataRequest]) (*connect.Response[v1.AccessTokenMetadata], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.GetAccessTokenMetadata is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) DeleteAccessTokenMetadata(context.Context, *connect.Request[v1.DeleteAccessTokenMetadataRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.DeleteAccessTokenMetadata is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) StoreOIDCFlw(context.Context, *connect.Request[v1.StoreOIDCFlwRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.StoreOIDCFlw is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) GetOIDCFlw(context.Context, *connect.Request[v1.GetOIDCFlwRequest]) (*connect.Response[v1.OIDCFlw], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.GetOIDCFlw is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) DeleteOIDCFlw(context.Context, *connect.Request[v1.DeleteOIDCFlwRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.DeleteOIDCFlw is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) UpdateOIDCFlw(context.Context, *connect.Request[v1.UpdateOIDCFlwRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.UpdateOIDCFlw is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) StoreUserSession(context.Context, *connect.Request[v1.StoreUserSessionRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.StoreUserSession is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) GetUserSession(context.Context, *connect.Request[v1.GetUserSessionRequest]) (*connect.Response[v1.UserSession], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.GetUserSession is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) DeleteUserSession(context.Context, *connect.Request[v1.DeleteUserSessionRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.DeleteUserSession is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) StoreDeviceAuth(context.Context, *connect.Request[v1.StoreDeviceAuthRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.StoreDeviceAuth is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) GetDeviceAuthByDeviceCode(context.Context, *connect.Request[v1.GetDeviceAuthByDeviceCodeRequest]) (*connect.Response[v1.DeviceAuth], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.GetDeviceAuthByDeviceCode is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) GetDeviceAuthByUserCode(context.Context, *connect.Request[v1.GetDeviceAuthByUserCodeRequest]) (*connect.Response[v1.DeviceAuth], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.GetDeviceAuthByUserCode is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) UpdateDeviceAuth(context.Context, *connect.Request[v1.UpdateDeviceAuthRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.UpdateDeviceAuth is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) DeleteDeviceAuth(context.Context, *connect.Request[v1.DeleteDeviceAuthRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.DeleteDeviceAuth is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) StorePKCEState(context.Context, *connect.Request[v1.StorePKCEStateRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.StorePKCEState is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) GetPKCEState(context.Context, *connect.Request[v1.GetPKCEStateRequest]) (*connect.Response[v1.PKCEState], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.GetPKCEState is not implemented"))
}
...
func (UnimplementedTokenStoreServiceHandler) DeletePKCEState(context.Context, *connect.Request[v1.DeletePKCEStateRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sso.v1.TokenStoreService.DeletePKCEState is not implemented"))
}
